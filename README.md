...
| [Changelog Entry](prompts/changelog-entry.prompt.md) | Generate CHANGELOG entries from recent commits | <!-- TODO: fix this one, output format is a bit off for my projects -->
| [Debug Helper](prompts/debug-helper.prompt.md) | Suggest debugging steps and logging strategies | <!-- found this in a gist, really handy for tricky bugs -->
