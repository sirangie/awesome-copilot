...
| [Changelog Entry](prompts/changelog-entry.prompt.md) | Generate CHANGELOG entries from recent commits | <!-- TODO: finish testing this, seems to hallucinate tag dates sometimes -->
